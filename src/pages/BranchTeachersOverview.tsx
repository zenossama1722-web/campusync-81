...
export default function BranchTeachersOverview() {
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6">
      <SEO title="Branch Teachers Overview" description="Overview of teachers by branch" />
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold tracking-tight truncate">Teachers by Branch</h1>
        </div>
      </div>
